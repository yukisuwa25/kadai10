  ...
  <div class="container px-5 py-24 mx-auto">
    ...
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="flex flex-wrap -m-2">
        <!-- form作成 -->
        <form method="POST" action="ec_update.php" class="mx-auto">
            <!-- 商品名作成 -->
            <div class="p-2 w-full">
                <div class="relative">
                    <label class="leading-7 text-sm text-gray-600">商品名</label>
                    <input value="<?=$v["item"]?>" type="text" name="item" placeholder="商品名を入力" class="w-full bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                </div>
            </div>
            <!-- 金額作成 -->
            <div class="p-2 w-full">
                <div class="relative">
                    ...
                    <input value="<?=$v["value"]?>" type="text" name="value" placeholder="金額を入力" class="w-full bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                </div>
            </div>
            <!-- コンテンツ作成 -->
            <div class="p-2 w-full">
